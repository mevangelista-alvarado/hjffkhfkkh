...
# Referencia https://datos.cdmx.gob.mx/dataset/ubicacion-acceso-gratuito-internet-wifi-c5
...
point_access = df.groupby("Alcaldía")["Puntos_de_acceso"].sum().sort_values(ascending=False).reset_index(name='Puntos_de_acceso').copy()
...
app.layout = dbc.Container(
    fluid=True,
    children=[
        html.H1("Postes de la CDMX", style={'textAlign': 'center', 'color': '#f5e50a'}),
...
def update_map(selected_alcaldia, selected_colonia):
    ...
    try:
        ...
        fig = px.scatter_mapbox(
            ...
            lon='Longitud',
            hover_name='Colonia',
            title=f"Mapa de {selected_colonia.lower()} en {selected_alcaldia.lower()}",
            mapbox_style=mapbox_style,
            zoom=14,
